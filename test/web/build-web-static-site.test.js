...
try {
  ...
  test('does not write generated branch-root Pages artifacts', () => {
    assert.equal(fs.existsSync(ROOT_INDEX), false);
  ...
  test('preserves the GitHub Pages .nojekyll marker under docs', () => {
  ...
  test('copies bundled recommendation worker JavaScript next to the docs static HTML entrypoint only', () => {
