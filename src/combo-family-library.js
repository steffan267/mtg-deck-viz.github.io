...
const COMBO_FAMILIES = [
  ...
  },
  {
    ...
    title: 'Combat token-copy equipment plus fresh-token extra combats',
    maxCards: 2,
    confidenceGate: 'pattern',
    requiredFacts: [
      { role: 'copyEquipment', kind: 'capability', predicate: 'is-combat-copy-token-equipment' },
    ...
    examples: [{ name: 'combat copy equipment + extra-combat attacker', cards: ['Combat Copy Equipment', 'Extra Combat Attacker'] }],
    negativeFixtures: [{ name: 'combat copy equipment + non-extra-combat attacker', cards: ['Combat Copy Equipment', 'Vanilla Attacker'], reason: 'fresh token does not create another combat phase' }],
    knownFalsePositives: ['copy effects that happen outside combat', 'extra-combat effects that are once per game or not refreshed by a new token'],
    uiExplanation: 'The Equipment makes a hasty fresh token at each combat; that token attacks to create the next combat.',
  },
  {
