...
<style scoped>
.recommendations-drawer{background:var(--panel,#17151d);border-left:1px solid var(--line,rgba(255,255,255,.14));box-shadow:-14px 0 40px rgba(0,0,0,.35);display:flex;flex-direction:column;gap:.85rem;max-width:92vw;bottom:0;overflow:auto;padding:1rem;position:fixed;right:0;top:52px;width:min(420px,92vw);z-index:20}.recommendations-drawer.closed{display:none}.recommendations-drawer__header{align-items:center;display:flex;gap:.5rem;justify-content:space-between}.recommendations-drawer__header h2{font-size:18px;margin:0}.recommendations-drawer__controls{border-bottom:1px solid var(--line);border-top:1px solid var(--line);display:grid;gap:.6rem;grid-template-columns:auto auto;justify-content:start;padding:.75rem 0}.recommendations-drawer__controls select{grid-column:1 / -1;min-height:38px}.recommendations-drawer__status,.recommendations-drawer__empty{color:var(--dim,#94a3b8)}.recommendations-drawer__status{display:grid;font-weight:700;gap:.5rem}.recommendations-drawer__status progress{accent-color:var(--accent,#d9434f);display:block;width:100%}.recommendations-drawer .btn{align-items:center;background:linear-gradient(180deg,var(--panel2,#1f1c28),var(--panel,#17151d));border:1px solid var(--line,rgba(255,255,255,.14));border-radius:9px;color:var(--text,#e8e4f0);cursor:pointer;display:inline-flex;font:inherit;font-size:13px;font-weight:700;justify-content:center;line-height:1;padding:.45rem .75rem}.recommendations-drawer .btn:hover,.recommendations-drawer .btn.active{border-color:var(--accent,#d9434f);box-shadow:0 0 0 1px rgba(217,67,79,.2)}.recommendations-drawer select,.recommendations-drawer input{background:var(--panel2,#1f1c28);border:1px solid var(--line,rgba(255,255,255,.14));border-radius:10px;color:var(--text,#e8e4f0);font:inherit;width:100%}.rec-card{background:var(--panel2,#1f1c28);border:1px solid var(--line,#334155);border-radius:.75rem;overflow:hidden}.rec-head{align-items:center;background:transparent;border:0;color:inherit;cursor:pointer;display:grid;gap:.6rem;grid-template-columns:minmax(0,1fr);min-height:54px;padding:.75rem;text-align:left;width:100%}.rec-head:hover{background:rgba(255,255,255,.04)}.rec-name,.rec-meta{display:block;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.rec-name{font-size:13px}.rec-meta{color:var(--dim,#94a3b8);font-size:11px}
</style>
