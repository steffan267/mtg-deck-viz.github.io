...
export const ComboFamilyId: {
  ...
  readonly FoodSacrificeTokenFeedbackLoop: 'food-sacrifice-token-feedback-loop'
...
export const ResultClass: {
  ...
  readonly InfiniteBlink: 'infinite-blink'
...
export const Capability: {
  ...
  readonly IsMultiTargetBlinkSpell: 'is-multi-target-blink-spell'
  readonly BlinkTargetCount: 'blink-target-count'
  readonly IsEtbSpellRecursionToHand: 'is-etb-spell-recursion-to-hand'
  readonly IsBlinkResettableManaArtifact: 'is-blink-resettable-mana-artifact'
  readonly IsFoodSacrificeDrawEngine: 'is-food-sacrifice-draw-engine'
  readonly IsFoodTokenReplacement: 'is-food-token-replacement'
  readonly IsFoodSacrificeTokenTrigger: 'is-food-sacrifice-token-trigger'
  readonly IsArtifactCastFromTopEnabler: 'is-artifact-cast-from-top-enabler'
  readonly CastFromTopRequiresAttachedCreature: 'cast-from-top-requires-attached-creature'
